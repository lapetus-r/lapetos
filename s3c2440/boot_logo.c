...
//  설 명 : RGB 값을 16 비트 565 포맷 데이타로 바꾼다.
Word16	RGB2PIXEL565( int r, int g, int b )
{
	return ((((r) & 0xF8) << 8) | (((g) & 0xFC ) << 3) | (((b) & 0xF8 ) >> 3));
}

//  설 명 : SDRAM 메모리에 복사된 BMP 이미지를 표출한다.
...
// 설명 : TFT-LCD 초기화 및 부트로고를 화면에 출력한다.
